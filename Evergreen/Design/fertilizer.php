...
<body>
    ...
    <section class="product" id="product">
        ...
        <h1 class="heading"> fertilizers </h1>
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <img src="img/Mealy Care.jpg">
                <h3>Mealy Care (100 ml)</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <img src="img/Neem Oil.jpg">
                <h3>Neem Oil (100 ml)</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <img src="img/cocopeat_block.jpg">
                <h3>cocopeat block (5 Kg)</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <img src="img/Vermi compost Fertilizer.jpg">
                <h3>Vermi compost Fertilizer (1 Kg)</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <img src="img/fertilizer01.jpg">
                <h3>Vermi Fertilizer (1 Kg)</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
