...
<body>
    ...
    <section class="product" id="product">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <img src="img/Kaner Pink Plant.jpg">
                <h3>Kaner Pink Plant</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <img src="img/Marigold Orange Plant.jpg">
                <h3>Marigold Orange Plant</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <img src="img/Allamanda Yellow Plant.jpg">
                <h3>Allamanda Yellow Plant</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
    ...
    <ul class="pagination">
        ...
        <li class="pagination-item"> <a href="flower2.php"> 2 </a></li>
        <li class="pagination-item"><a href="flower2.php"> &raquo; </a></li>
    </ul>
