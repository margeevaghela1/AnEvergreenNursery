    ...
    <section class="product" id="product">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <img src="img/Adenium Red Plant.jpg">
                <h3>Adenium Red Plant</h3>
                <div class="stars">
            ...
            <div class="box">
                ...
                <img src="img/Adenium Pink-White Double Petal Plant.jpg">
                <h3>Adenium Pink & White Petal Plant</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <img src="img/Adenium White Double Petal Plant.jpg">
                <h3>Adenium White Double Petal Plant</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
